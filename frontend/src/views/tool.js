...
function App() {
    ...
    useEffect(() => {
        ...
        const ws = new WebSocket('ws://student-judgementgamewebdemo.onrender.com/ws'); // Ensure this is the correct URL for your WebSocket connection
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('https://student-judgementgamewebdemo.onrender.com/process-filings/', {
                method: 'POST',
                headers: {
